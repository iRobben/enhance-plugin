 ...
 * @author zhangrh
 */
public class PluginDisableHandler implements HttpHandler {

    private PluginFactory pluginFactory;

    public PluginDisableHandler(PluginFactory pluginFactory) {
    ...
    public void handle(HttpExchange exchange) {
        ...
        try {
            ...
            pluginFactory.disablePlugin(pluginDefinition.getId());
