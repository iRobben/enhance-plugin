 ...
 * @author zhangrh
 */
public class PluginUnInstallHandler implements HttpHandler {

    private PluginFactory pluginFactory;

    public PluginUnInstallHandler(PluginFactory pluginFactory) {
    ...
    public void handle(HttpExchange exchange) {
        ...
        try {
            ...
            pluginFactory.unInstallPlugin(pluginDefinition);
