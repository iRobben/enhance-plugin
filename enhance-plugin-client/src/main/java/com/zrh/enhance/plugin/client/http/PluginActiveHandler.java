 ...
 * @author zhangrh
 */
public class PluginActiveHandler implements HttpHandler {
    private PluginFactory pluginFactory;

    public PluginActiveHandler(PluginFactory pluginFactory) {
    ...
    public void handle(HttpExchange exchange) {
        ...
        try {
            ...
            pluginFactory.activePlugin(pluginDefinition.getId());
